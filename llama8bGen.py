...
local_model_path = "hfmodels/Meta-Llama-3-8B-Instruct"
...
class LocalLLM:
    def __init__(self):
        if quantization_config:
            ...
            # self.model = AutoModelForCausalLM.from_pretrained(model_id, token=hf_token, device_map="auto", force_download=True, torch_dtype=torch.float16, attn_implementation="flash_attention_2")
